...
- [ ] Mongoose-модель `Plant` (поля ухода, категория, интервалы)
- [ ] GridFS для изображений, генерация превью 128×128
- [ ] REST CRUD `/api/plants` (создание, чтение, обновление, удаление)
- [ ] Лимит загрузки 5 МБ
